...
<div class="w-60 p-5 h-min sticky top-[48px]" id="left-sidebar">
    ...
    ?>
        <button onclick="location.href='/'" class="mb-2 text-[11px] font-semibold <?php echo $active2 == "bangtin" ? "bg-[#E4EEE3]" : "" ?> flex items-center w-[100%] text-left <?php echo $active2 == "bangtin" ? "text-[#319527]" : "text-[#CACACA]" ?> rounded-lg p-1.5">
        ...
        <button onclick="location.href='/forum'" class="mb-2 text-[11px] font-semibold <?php echo $active2 == "diendan" ? "bg-[#E4EEE3]" : "" ?> flex items-center w-[100%] text-left <?php echo $active2 == "diendan" ? "text-[#319527]" : "text-[#CACACA]" ?> rounded-lg p-1.5">
        ...
        <button onclick="location.href='/recordings'" class="mb-2 text-[11px] font-semibold <?php echo $active2 == "loalon" ? "bg-[#E4EEE3]" : "" ?> flex items-center w-[100%] text-left <?php echo $active2 == "loalon" ? "text-[#319527]" : "text-[#CACACA]" ?> rounded-lg p-1.5">
        ...
        <button onclick="location.href='/youth-news'" class="mb-2 text-[11px] font-semibold <?php echo $active2 == "tintucdoan" ? "bg-[#E4EEE3]" : "" ?> flex items-center w-[100%] text-left <?php echo $active2 == "tintucdoan" ? "text-[#319527]" : "text-[#CACACA]" ?> rounded-lg p-1.5">
        ...
        <button onclick="location.href='/saved'" class="mb-2 text-[11px] font-semibold <?php echo $active2 == "daluu" ? "bg-[#E4EEE3]" : "" ?> flex items-center w-[100%] text-left <?php echo $active2 == "daluu" ? "text-[#319527]" : "text-[#CACACA]" ?> rounded-lg p-1.5">
    ...
    ?>
        <button onclick="location.href='/report/class'" class="mb-2 text-[11px] font-semibold <?php echo $active2 == "tapthelop" ? "bg-[#E4EEE3]" : "" ?> flex items-center w-[100%] text-left <?php echo $active2 == "tapthelop" ? "text-[#319527]" : "text-[#CACACA]" ?> rounded-lg p-1.5">
        ...
        <button onclick="location.href='/report/student'" class="mb-2 text-[11px] font-semibold <?php echo $active2 == "hocsinh" ? "bg-[#E4EEE3]" : "" ?> flex items-center w-[100%] text-left <?php echo $active2 == "hocsinh" ? "text-[#319527]" : "text-[#CACACA]" ?> rounded-lg p-1.5">
